...
public class DownloadHandler implements Handler{
    ...
    public DownloadHandler(MyAudioRepo myAudioRepo) {
    ...
    public List<PartialBotApiMethod<? extends Serializable>> handle(Update update) {
        ...
        final int myAudioId = Integer.parseInt(BotUtil.getParamRequest(update).get("/download"));
        MyAudio myAudio = myAudioRepo.findById(myAudioId).orElse(BotUtil.getRandomAudio(myAudioRepo));
